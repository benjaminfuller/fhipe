...
n=4
group_name='MNT159'
barbosa = multibasispredipe.BarbosaIPEScheme(n, group_name, 1)
...
assert(multibasispredipe.BarbosaIPEScheme.decrypt(barbosa.getPublicParameters(), ctx, tky1, group_name))
# assert(multibasispredipe.BarbosaIPEScheme.decrypt(barbosa.getPublicParameters(), ctzero, tky1))
# assert(not multibasispredipe.BarbosaIPEScheme.decrypt(barbosa.getPublicParameters(), ctx, tky2))
