...
# assert(multibasispredipe.MultiBasesPredScheme.fake_decrypt(barbosa.getPublicParameters(), ctx, tky1, group_name))
# assert(multibasispredipe.MultiBasesPredScheme.fake_decrypt(barbosa.getPublicParameters(), ctzero, tky1))
# assert(not multibasispredipe.MultiBasesPredScheme.fake_decrypt(barbosa.getPublicParameters(), ctx, tky2))
